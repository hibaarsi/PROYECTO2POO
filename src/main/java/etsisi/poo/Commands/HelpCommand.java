...
public class HelpCommand implements ICommand {
    ...
    public String execute(String[] args) {
        ...
        sb.append("Commands:\n")
                .append(SPACE).append("client add \"<nombre>\" (<DNI>|<NIF>) <email> <cashId>\n")
                ...
                .append(SPACE).append("ticket new [<id>] <cashId> <userId> -[c|p|s] (default -p option)\n")
                ...
                .append(SPACE).append("prod add ([<id>] \"<name>\" <category> <price> [<maxPers>]) || (\"<name>\" <category>)\n")
